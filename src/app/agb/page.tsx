  ...
  return (
    <PageLayout>
      <article className="mx-auto max-w-3xl px-6 py-24 md:py-32">
        ...
        <h2 className="text-lg font-light text-foreground/60 mb-12">
          Allgemeine Liefer- und Zahlungsbedingungen
        </h2>

        <div className="space-y-10 text-sm font-light leading-relaxed text-foreground/70">
          <section>
            <h3 className="text-base font-normal text-foreground mb-4">Geltung</h3>
            <p className="mb-3">
          ...
          <section>
            <h3 className="text-base font-normal text-foreground mb-4">Angebot und Vertragsabschluss</h3>
            <p className="mb-3">
          ...
          <section>
            <h3 className="text-base font-normal text-foreground mb-4">Preise und Zahlungen</h3>
            <p className="mb-3">
          ...
          <section>
            <h3 className="text-base font-normal text-foreground mb-4">Lieferung und Lieferzeit</h3>
            <p className="mb-3">
          ...
          <section>
            <h3 className="text-base font-normal text-foreground mb-4">Gewährleistung / Haftung</h3>
            <p className="mb-3">
          ...
          <section>
            <h3 className="text-base font-normal text-foreground mb-4">Eigentumsvorbehalt</h3>
            <p className="mb-3">
            ...
            <p className="mb-3">Der AG verwahrt die Vorbehaltsware unentgeltlich für uns.</p>
            <p className="mb-3">
          ...
          <section>
            <h3 className="text-base font-normal text-foreground mb-4">Gerichtsstand / Rechtswahl</h3>
            <p className="mb-3">
          ...
          <section>
            <h3 className="text-base font-normal text-foreground mb-4">Allgemeines</h3>
            <p>
